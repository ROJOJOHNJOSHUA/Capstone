...
function ParishionerMenuItem({ to, icon: Icon, children, badge, onSelect }) {
  return (
    <Link
      ...
      role="menuitem"
      onClick={onSelect}
      className="flex items-center gap-3 mx-2 px-3 py-2.5 rounded-xl text-sm font-medium text-[#4a4438] dark:text-gray-200 hover:bg-[#f5ead5] dark:hover:bg-gray-700/80 transition-colors duration-200"
    >
      <span className="flex items-center justify-center w-9 h-9 rounded-lg bg-[#f5ead5] text-[#a6813f] dark:bg-gray-700/80 dark:text-parish-gold shrink-0">
    ...
    <>
              ...
              <>
                <Link
                  ...
                  className={`relative inline-flex h-10 w-10 items-center justify-center rounded-full transition ${
                    dashboard
                      ? 'text-[#58616a] hover:bg-[#f1e7d1] hover:text-[#a6813f]'
                      : 'text-white/85 hover:bg-white/10 hover:text-[#d7b57a]'
                  }`}
                >
                  ...
                  >
                      ...
                      {isAdmin ? (
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="text-xs text-[#9a8666] dark:text-gray-400 leading-tight mt-0.5 truncate">
                              {user.email}
                            </p>
                          </div>
                        </div>
                    ...
                    {isAdmin ? (
                      ...
                      <div className="py-2">
                        ...
                        <div className="my-2 mx-4 border-t border-[#eee5d6] dark:border-gray-700" />
      ...
      <RegisterModal
        ...
        onRegistered={() => {
          ...
          setTimeout(() => setRegisteredFlash(false), 5000);
        }}
        onLoginClick={() => setAccountOpen(true)}
      />
      {registeredFlash && (
        <div className="fixed left-1/2 top-24 z-[210] -translate-x-1/2 rounded-xl border border-emerald-200 bg-emerald-50 px-5 py-3 text-sm font-semibold text-emerald-800 shadow-[0_18px_40px_rgba(15,31,45,0.18)]">
