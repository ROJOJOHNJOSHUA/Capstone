          ...
          <div className="mobile-scroll-snap hide-scrollbar flex gap-5 pb-2">
            {services.map((service) => (
              <article
                ...
                className="group aspect-square w-[calc((100%-1.25rem)/2)] max-w-[280px] shrink-0 cursor-pointer overflow-hidden rounded-xl border border-[#e5dccf] bg-[#fcfbf8] text-left shadow-[0_8px_22px_rgba(83,65,34,0.07)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_14px_30px_rgba(83,65,34,0.12)] focus:outline-none focus:ring-2 focus:ring-[#b18a45]/50"
              >
