...
export const resetPasswordWithOtp = (data) => api.post('/auth/resetPasswordWithOtp.php', data);
...
export const getSystemLogs = (params) => api.get('/system-logs/index.php', { params });
