...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        logSystemAction($db, $userId, 'Document Uploaded', 'Documents', "Uploaded a document for reservation #{$reservationId}.", 'Document', $documentId);
...
if ($_SERVER['REQUEST_METHOD'] === 'PATCH') {
    ...
    try {
        ...
        logSystemAction($db, (int) $auth['user_id'], "Document {$status}", 'Documents', "Marked document #{$documentId} as {$status}.", 'Document', $documentId);
...
if ($_SERVER['REQUEST_METHOD'] === 'DELETE') {
    ...
    try {
        ...
        logSystemAction($db, $userId, 'Document Deleted', 'Documents', "Deleted document #{$documentId}.", 'Document', $documentId);
