...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $isMarriage = $data['service_type'] === 'Marriage';
    ...
    try {
        ...
        $stmt->execute([
            ...
            ($isMarriage || $isFuneral || $isPrivateMass) ? json_encode($serviceDetails, JSON_UNESCAPED_UNICODE) : null,
    ...
    logSystemAction($db, (int) $auth['user_id'], 'Reservation Created', 'Reservation', "Submitted a {$data['service_type']} reservation.", 'Reservation', $newId);
