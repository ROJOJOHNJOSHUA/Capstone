...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    logSystemAction($db, (int) $auth['user_id'], 'Appointment Created', 'Appointment', "Requested an appointment for {$date} at {$time}.", 'Appointment', $newId);
...
if ($_SERVER['REQUEST_METHOD'] === 'PATCH') {
    ...
    if ($statusChanged) {
        logSystemAction($db, (int) $auth['user_id'], "Appointment {$status}", 'Appointment', "Appointment #{$id} was marked {$status}.", 'Appointment', $id);
    }
