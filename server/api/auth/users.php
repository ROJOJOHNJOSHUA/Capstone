...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    logSystemAction($db, (int) $auth['user_id'], 'User Created', 'Users', "Created {$role} account #{$id}.", 'User', $id);
...
if ($_SERVER['REQUEST_METHOD'] === 'PUT') {
    ...
    $action = $existing['role'] !== $newRole ? 'User Role Changed' : 'User Updated';
    logSystemAction($db, (int) $auth['user_id'], $action, 'Users', "Updated account #{$id}.", 'User', $id);
...
if ($_SERVER['REQUEST_METHOD'] === 'DELETE') {
    ...
    logSystemAction($db, (int) $auth['user_id'], 'User Deleted', 'Users', "Deleted account #{$id}.", 'User', $id);
