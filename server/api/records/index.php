...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    logSystemAction($db, (int) $auth['user_id'], 'Record Created', 'Records', 'Created an official parish record.', 'Record', $newId);
    successResponse(['id' => $newId], 'Record created.', 201);
}
...
if ($_SERVER['REQUEST_METHOD'] === 'PUT') {
    ...
    logSystemAction($db, (int) $auth['user_id'], 'Record Updated', 'Records', "Updated official parish record #{$id}.", 'Record', $id);
...
if ($_SERVER['REQUEST_METHOD'] === 'DELETE') {
    ...
    logSystemAction($db, (int) $auth['user_id'], 'Record Deleted', 'Records', "Deleted official parish record #{$id}.", 'Record', $id);
