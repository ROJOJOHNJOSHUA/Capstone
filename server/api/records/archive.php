...
if ($_SERVER['REQUEST_METHOD'] === 'DELETE') {
    ...
    if ($deleteParishRecordId > 0) {
        ...
        logSystemAction($db, (int) $auth['user_id'], 'Record Deleted', 'Records', "Deleted archived parish record #{$deleteParishRecordId}.", 'Record', $deleteParishRecordId);
    }

    if ($deleteReservationId > 0) {
        logSystemAction($db, (int) $auth['user_id'], 'Record Deleted', 'Records', "Deleted the archived reservation record #{$deleteReservationId}.", 'Reservation', $deleteReservationId);
    }
